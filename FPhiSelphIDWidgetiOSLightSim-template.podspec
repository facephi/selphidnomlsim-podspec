#
#  Be sure to run `pod spec lint FPhiSelphIDWidgetiOSLightSim.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    spec.name         = "FPhiSelphIDWidgetiOSLightSim"
    spec.version      = "$VERSION_RELEASE"
    spec.summary      = "A short description of FPhiSelphIDWidgetiOSLightSim."
    ...
    spec.source       = { :git => "https://github.com/facephi/selphidnomlsim-framework.git", :tag => "#{spec.version}" }
